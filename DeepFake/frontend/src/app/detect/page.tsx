...
import { AlertCircle, Loader2, Play, RotateCcw, FileAudio, FileVideo } from 'lucide-react';
...
export default function DetectPage() {
  ...
  const { isAnalyzing, uploadProgress, result, error, analyzeVideo, reset } = useDetection();
  ...
  const getProgressStageMessage = () => {
    switch (uploadProgress.stage) {
      case 'uploading': return 'Uploading media to server...';
      case 'processing': return uploadProgress.message || 'Processing media streams...';
      case 'analyzing': return 'Analyzing for synthetic patterns...';
  ...
  const videoConf = Number(videoAnalysis?.conf || videoAnalysis?.confidence || result?.videoConfidence || 0);
  ...
  const audioConf = Number(audioAnalysis?.conf || audioAnalysis?.confidence || result?.audioConfidence || 0);
  const isAudioFake = audioLabel === 'fake';
  const isAudioUnavailable = audioLabel === 'Not Detected' || audioLabel === 'unavailable' || audioLabel === 'unknown';
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            ...
            <strong> Visual</strong> and <strong> Auditory</strong> channels to detect manipulation.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          {!result ? (
                ...
                <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-6 mt-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="mt-4">
                        <Button variant="outline" onClick={handleAnalyzeAnother} className="border-red-300 text-red-700">
            ...
            <div className=" p-6 md:p-8 animate-fade-in ">
                <DetectionResults result={result} onAnalyzeAnother={handleAnalyzeAnother} />
            </div>
          )}
        </div>
        ...
        {!result && (
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Analysis Features</h3>
              <ul className="space-y-2 text-gray-600 dark:text-gray-400 text-sm">
                <li className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 bg-primary-600 rounded-full"/>
